...
public class EmpSimple {
	...
	public EmpSimple(String company, int empRatePerHour, int numOfWorkingDays, int maxhoursPerMonth)
	{
	...
	public static void main(String[] args) {
		EmpSimple info = new EmpSimple("infosys" ,20,2,10);
		EmpSimple cogni = new EmpSimple("cognizath" ,40,4,20);
		info.computeEmpWage();
